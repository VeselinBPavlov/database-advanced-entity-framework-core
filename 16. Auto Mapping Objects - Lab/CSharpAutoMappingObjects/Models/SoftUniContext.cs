...
namespace CSharpAutoMappingObjects.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=(localdb)\\MyInstance;AttachDbFilename=D:\\Courses\\Data\\SoftUni_Data.mdf;Database=SoftUni;Integrated Security=true;");
            }
        }
